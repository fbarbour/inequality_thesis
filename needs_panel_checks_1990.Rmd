...
```{r}
fp1 <- c("life_sat", "san_sat", "energy_sat")
fp2 <- c(rep(" + log_carbon", 3), rep(" + log_MF", 3), rep(" + log_carbon", 3), rep(" + log_MF", 3))
frm <- c(" ~ gini_disp + gini_wealth")
cntrl <- c(rep("", 6), rep(" + urbanisation + log_popDensity", 6))
frms <- paste0(fp1, frm, fp2, cntrl)

#fp <- c("life_sat", "san_sat", "energy_sat")
#frm <- c(" ~ gini_disp + gini_wealth + log_MF + log_carbon + log_MF:log_carbon")
#cntrl <- c(rep("", 3), rep(" + urbanisation + log_popDensity", 3))
